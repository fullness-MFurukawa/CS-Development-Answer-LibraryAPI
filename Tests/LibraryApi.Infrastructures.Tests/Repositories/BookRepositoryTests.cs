...
public class BookRepositoryTests : RepositoryTestBase
{
    ...
    [TestMethod("書名のキーワードで図書を部分一致検索する")]
    ...
    [TestMethod("検索結果の図書は分類と蔵書を含む集約として構築される")]
    ...
    [TestMethod("ヒットしないキーワードでは空のリストが返る")]
    ...
    [TestMethod("図書と蔵書をまとめて新規追加し集約として取得できる")]
    ...
    [TestMethod("存在しない分類を参照して追加するとEntityNotFoundExceptionをスローする")]
    ...
    [TestMethod("存在しない図書を更新するとEntityNotFoundExceptionをスローする")]
    ...
    [TestMethod("存在しない図書を削除するとEntityNotFoundExceptionをスローする")]
