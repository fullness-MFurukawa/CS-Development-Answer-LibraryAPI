...
public class AuthControllerTests
{
    ...
    [TestMethod("ログイン:成功時200 OKでメッセージを返しCookieをセットする")]
    public async Task Login_TestCase01()
    {
        ...
        Assert.IsTrue(setCookie.Contains("access_token"));
        Assert.IsTrue(setCookie.Contains("issued-token"));
    }

    [TestMethod("ログイン:認証失敗例外を素通しする")]
    ...
    [TestMethod("ログアウト:200 OKでメッセージを返しCookieを削除する")]
