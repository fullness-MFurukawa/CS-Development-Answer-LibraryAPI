...
public class BookStockTests
{
    ...
    [TestMethod("有効な蔵書数を渡すとインスタンスを生成する")]
    ...
    [TestMethod("既存のUUIDと蔵書数から復元するとUUIDが引き継がれる")]
    ...
    [TestMethod("蔵書数が不正ならDomainExceptionをスローする")]
    ...
    [TestMethod("有効な蔵書数を渡すと蔵書数が変更される")]
    ...
    [TestMethod("不正な蔵書数を渡すとDomainExceptionをスローする")]
    ...
    [TestMethod("変更が失敗しても元の蔵書数は保持される")]
