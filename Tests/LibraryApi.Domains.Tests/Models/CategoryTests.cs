...
public class CategoryTests
{
    ...
    [TestMethod("有効な分類名を渡すとインスタンスを生成する")]
    ...
    [TestMethod("分類名が21文字以上ならDomainExceptionをスローする")]
    ...
    [TestMethod("既存のUUIDと分類名から復元するとUUIDが引き継がれる")]
    ...
    [TestMethod("分類名が不正ならDomainExceptionをスローする")]
    ...
    [TestMethod("不正な分類名を渡すとDomainExceptionをスローする")]
