...
public class BookTests
{
    ...
    [TestMethod("有効な値を渡すとインスタンスを生成する")]
    ...
    [TestMethod("生成時に蔵書(BookStock)が内包され蔵書数が反映される")]
    ...
    [TestMethod("生成時に渡した分類(Category)が参照として保持される")]
    ...
    [TestMethod("生成のたびに異なるUUIDが採番される")]
    ...
    [TestMethod("著者名が境界値の30文字なら生成できる")]
    ...
    [TestMethod("書名が51文字以上ならDomainExceptionをスローする")]
    ...
    [TestMethod("著者名が31文字以上ならDomainExceptionをスローする")]
    ...
    [TestMethod("分類がnullならDomainExceptionをスローする")]
    ...
    [TestMethod("蔵書数が不正なら内包するBookStockがDomainExceptionをスローする")]
    ...
    [TestMethod("既存の値から復元するとUUIDと内包する蔵書が引き継がれる")]
    ...
    [TestMethod("蔵書(BookStock)がnullならDomainExceptionをスローする")]
    ...
    [TestMethod("変更時も内包する蔵書のインスタンスは差し替わらない")]
    ...
    [TestMethod("書名が不正ならDomainExceptionをスローする")]
