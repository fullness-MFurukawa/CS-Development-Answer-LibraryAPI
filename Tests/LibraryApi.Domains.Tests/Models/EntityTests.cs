...
public class EntityTests
{
    ...
    [TestMethod("同じUUIDを持つエンティティ同士は等しい")]
    ...
    [TestMethod("異なるUUIDを持つエンティティ同士は等しくない")]
    ...
    [TestMethod("UUIDが未設定(空文字)の場合は参照が同一のときのみ等しい")]
    ...
    [TestMethod("同じUUIDを持つエンティティは同じハッシュコードを返す")]
    ...
    [TestMethod("同じUUIDを持つエンティティは==でtrueになる")]
    ...
    [TestMethod("異なるUUIDを持つエンティティは==でfalseになる")]
    ...
    [TestMethod("一方だけがnullなら==でfalseになる")]
