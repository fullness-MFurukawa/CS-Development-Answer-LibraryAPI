...
public class UserTests
{
    ...
    [TestMethod("有効なユーザー名とハッシュ化済みパスワードを渡すとインスタンスを生成する")]
    ...
    [TestMethod("ユーザー名が境界値の30文字なら生成できる")]
    ...
    [TestMethod("ユーザー名が31文字以上ならDomainExceptionをスローする")]
    ...
    [TestMethod("既存のUUID・ユーザー名・パスワードから復元するとUUIDが引き継がれる")]
    ...
    [TestMethod("ユーザー名が不正ならDomainExceptionをスローする")]
    ...
    [TestMethod("パスワードが不正ならDomainExceptionをスローする")]
